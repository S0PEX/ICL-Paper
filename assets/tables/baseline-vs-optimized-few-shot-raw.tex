...
\begin{table}[hbp]
  \caption[Default vs. Optimized System Prompt Few-Shot Experiment Results (RAW)]{Default vs. Optimized System Prompt Few-Shot Experiment Results (RAW): 'Ori \& Sem' means 'Original \& Semantic' while 'O \& S \& C' means 'Original \& Semantic \& Context'. 'Overall' is the average of 'Ori', 'Sem', and 'Con'. 'RAW' means that the accuracy values were calculated from raw model responses. Values not in parentheses refer to the Default System Prompt, while those in braces refer to the results obtained with the Optimized System Prompt.}
