    ...
    \begin{table}[hbp]
\caption[Few-Shot: Default vs. Optimized System Prompt (Raw)]{Few-Shot: Default vs. Optimized System Prompt (Raw): 'Ori \& Sem' means 'Original \& Semantic' while 'O \& S \& C' means 'Original \& Semantic \& Context'. 'Overall' is the average of 'Ori', 'Sem', and 'Con'. 'RAW' means that the accuracy values were calculated from raw model responses.}
