...
\begin{table}[]
  \caption[Optimized Zero-Shot vs. Optimized Few-Shot Experiment Results]{Optimized Zero-Shot vs. Optimized Few-Shot Experiment Results: 'Ori \& Sem' means 'Original \& Semantic' while 'O \& S \& C' means 'Original \& Semantic \& Context'. 'Overall' is the average of 'Ori', 'Sem', and 'Con'. 'RAW' refers to unprocessed model responses, while 'POST' refers to postprocessed model responses. Values not in parentheses refer to Zero-Shot, while those in braces refer to the results obtained with Few-Shot.}
