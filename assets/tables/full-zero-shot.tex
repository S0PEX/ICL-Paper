    ...
    \begin{table}[]
\caption[Zero-Shot: Default vs. Optimized System Prompt]{Zero-Shot: Default vs. Optimized System Prompt: 'Ori \& Sem' means 'Original \& Semantic' while 'O \& S \& C' means 'Original \& Semantic \& Context'. 'Overall' is the average of 'Ori', 'Sem', and 'Con'. 'RAW' refers to unprocessed model responses, while 'POST' refers to postprocessed model responses.}
